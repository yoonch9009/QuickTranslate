...
extra_args = --quiet --noinclude-qt-translations --windows-console-mode=disable --file-description=QuickTranslate --product-name=QuickTranslate --file-version=1.8.1.0 --product-version=1.8.1.0 --assume-yes-for-downloads
