...
extra_args = --quiet --noinclude-qt-translations --windows-console-mode=disable --file-description=QuickTranslate --product-name=QuickTranslate --file-version=1.5.0.0 --product-version=1.5.0.0 --assume-yes-for-downloads
